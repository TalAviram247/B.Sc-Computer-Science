...
public class Fraction {
     ...
     */
     public Fraction pow(int n) {
        // Replace the following statement with your code
         int powNumerator = (int) Math.pow(numerator,n);
         int powDenominator = (int) Math.pow(denominator,n);
         return new Fraction(powNumerator,powDenominator);
    }
     ...
     */
     public Fraction abs() {
         // Replace the following statement with your code
         if (numerator < 0){
             Fraction neg = new Fraction(numerator*(-1),denominator);
             return neg;
         }
    ...
    public int compareTo(Fraction other) {
        // Replace the following statement with your code
        Fraction ans = this.subtract(other);
        return ans.signum();
    }
